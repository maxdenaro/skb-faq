...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_get_year__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/get-year */ "./src/js/components/get-year.js");
/* harmony import */ var _components_search_logic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/search-logic */ "./src/js/components/search-logic.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  yearEl: (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.year'),
  searchInput: (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelector('.search__input'),
  searchResults: (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelector('.search__list'),
  searchForm: (_document4 = document) === null || _document4 === void 0 ? void 0 : _document4.querySelector('.search__form'),
  searchDropdown: (_document5 = document) === null || _document5 === void 0 ? void 0 : _document5.querySelector('.search__dropdown')
});
...
_vars__WEBPACK_IMPORTED_MODULE_0__["default"].yearEl.textContent = year;

/***/ }),

/***/ "./src/js/components/search-logic.js":
/*!*******************************************!*\
  !*** ./src/js/components/search-logic.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.accordion')) {
  accordion = new (accordion_js__WEBPACK_IMPORTED_MODULE_1___default())('.accordion', {
    duration: 400,
    showMultiple: true,
...
_vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchForm.addEventListener('submit', function (e) {
  e.preventDefault(); // document.querySelector('.search__close').focus();
});
var simpleBar = new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](_vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchResults);
var search_term = '';
var searchData;

var fetchData = function fetchData() {
  fetch('/search-feed.json').then(function (res) {
    return res.json();
  }).then(function (res) {
    _vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchResults.querySelector('.simplebar-content').innerHTML = '';
    searchData = res;
    searchData.posts.filter(function (item) {
      return item.title.toLowerCase().includes(search_term.toLowerCase());
    }).forEach(function (item) {
      if (item.title) {
        simpleBar.recalculate();
        _vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchDropdown.classList.add('search__dropdown--active'); // let url = item.url.slice(0, -2);

        _vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchResults.querySelector('.simplebar-content').insertAdjacentHTML('afterbegin', "\n              <li class=\"search__item\">\n                <a href=\"".concat(item.url, "\" class=\"search__link\">\n                  ").concat(item.title, "\n                </a>\n              </li>\n            "));
      } else {
        _vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchDropdown.classList.remove('search__dropdown--active');
      }
    });
  });
};

_vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchInput.addEventListener('keyup', function (e) {
...
_vars__WEBPACK_IMPORTED_MODULE_2__["default"].searchDropdown.addEventListener('click', function (e) {
  if (e.target.classList.contains('search__link')) {
    e.preventDefault();
    var num = e.target.getAttribute('href');
    var numNew = num.substring(num.length - 2, num.length - 1);
    localStorage.setItem('faq-num', numNew);
    location.href = e.target.getAttribute('href').slice(0, -2);
  }
});

if (location.pathname.includes('module') && localStorage.getItem('faq-num')) {
  var n = parseInt(localStorage.getItem('faq-num'));
  accordion.open(n - 1);
  localStorage.removeItem('faq-num');
}
